    ...
    <script type="module">
        ...
        function processInputAnswers(){
            $('#btn-add-answers-correct').on('click',()=>{
                ...
                if(valueAnswer.val() != ""){
                    let lengthAnswers = $('#box-answers-correct li').length;
            ...
            $('#btn-add-answers-incorrect').on('click',()=>{
                ...
                if(valueAnswer.val() != ""){
                    ...
                    <li class="w-full border-b border-gray-200 h-[50px] flex flex-row bg-transparent text-sm ">
                        <span class="w-[80%] my-auto px-2">${valueAnswer.val()}</span>
                        <button class="w-[20%] bg-red-500 m-auto h-full hover:bg-red-600 btn-remove-answer"><i class="fa fa-minus-circle text-white text-lg" aria-hidden="true"></i></button>
                    </li>
                    `)
                    valueAnswer.val(""); 
                    processRemoveAnswer();
