...
@section('content')
    ...
    <script type="module">
        ...
        function processDeleteQuestion(){
            $('#btn-delete-question').on('click',()=>{
                Swal.fire({
                    title: "Apakah Kamu Yakin Akan Menghapus Soal Ini?",
                    text: "Data akan dihapus dan semua poin pada siswa akan di kurangi!!",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        ...
                        let routePost = '{{route('questionDeleteProcess', [$class->id_class, $question["id_question"]])}}';
                        $.post(routePost, body, function (data, status){
                            if(data.status == 200){
                                Swal.fire({
                                    title: "Success",
                                    text: "Delete Soal Berhasil",
                                    icon: "success"
                                });
